# BCG X Data Science Job Simulation — SME Churn Prediction

This repository contains my end-to-end work for the **BCG X Data Science Job Simulation** on Forage, analyzing customer turnover for small and medium enterprises (SMEs) in the energy market.

## 📌 Project Overview
* **Objective:** Understand SME customer churn drivers and build a predictive model to help retain high-value accounts.
* **Key Finding:** Blanket discounts are ineffective because price sensitivity is not the primary driver; net and gross margins on electricity consumption over the past 12 months are the strongest indicators.
